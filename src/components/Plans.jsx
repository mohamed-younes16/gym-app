    ...
    <div className=" relative" id="plans">
        ...
        <div className="flex justify-center">
            <Animated del={2}> <h1 className="italic text-[3rem] max-sm:text-[2.5rem] uppercase font-bold relative  text-center">
                ...
                <span className="clip-text">NOW WITHUS </span>
        ...
        <div className="flex items-center max-sm:space-y-12 relative   mt-20 flex-wrap justify-center gap-16">
            ...
            <div className="plan bg-[#656565] p-6 rounded-lg">
                    ...
                    <svg  className="fill-orange-700" width="35" height="35" viewBox="0 0 15 13" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.01789 5.76762H8.26715V5.03093C8.26715 4.83555 8.18806 4.64816 8.04727 4.51001C7.90648 4.37185 7.71552 4.29424 7.51641 4.29424C7.3173 4.29424 7.12635 4.37185 6.98556 4.51001C6.84477 4.64816 6.76567 4.83555 6.76567 5.03093V5.76762H6.01493C5.81582 5.76762 5.62487 5.84524 5.48408 5.98339C5.34329 6.12155 5.26419 6.30893 5.26419 6.50431C5.26419 6.6997 5.34329 6.88708 5.48408 7.02523C5.62487 7.16339 5.81582 7.24101 6.01493 7.24101H6.76567V7.9777C6.76567
                    ...
                    <div className="flex items-center gap-2 mt-9">
                        <p>see more Benefits</p><img src={arrow} alt="" className="h-[15px]" />
                    </div> 
                    <button className="bg-white p-2 w-full mt-6 font-bold text-md text-black">Join Now</button>
            ...
            <div className="plan p-6 scale-110 rounded-lg">

            <svg width="35" fill="white" height="35" viewBox="0 0 28 24" xmlns="http://www.w3.org/2000/svg"><path d="M3.11111 18L0 1.5L8.55556 9L14 0L19.4444 9L28 1.5L24.8889 18H3.11111ZM24.8889 22.5C24.8889 23.4 24.2667 24 23.3333 24H4.66667C3.73333 24 3.11111 23.4 3.11111 22.5V21H24.8889V22.5Z"></path></svg>
                
                <p className="font-bold text-lg  mt-10"> PREMIUM PLAN</p>
                <p className="text-[4rem] my-4 font-bold ">$ 40</p>

                <div className="flex gap-4 items-center my-2">
                    <img src={tick} alt="" width={20}  className="h-[20px]"/>
                    <p className="text-lg">8 hours of excercises</p>
                </div> 
